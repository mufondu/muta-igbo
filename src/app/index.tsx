...
const sh = StyleSheet.create({
  ...
  profileAvatarPill: { flexDirection: 'row', alignItems: 'center', minWidth: 92, maxWidth: 126, paddingVertical: 6, paddingLeft: 6, paddingRight: 10, borderRadius: RADIUS.pill, backgroundColor: 'rgba(255,255,255,0.18)', borderWidth: 1, borderColor: 'transparent' },
  ...
  kidsHeroAvatarWrap: { width: 98, height: 98, borderRadius: 999, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', overflow: 'visible' },
  kidsHeroCopy: { flex: 1 },
  ...
  kidsQuestIcon: { width: 76, height: 76, borderRadius: 28, alignItems: 'center', justifyContent: 'center', backgroundColor: KIDS_COLOR.sunshine, borderWidth: 5, borderColor: 'transparent' },
  ...
  kidsLevelCard: { ...KIDS_SHADOW.softCard, flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: 'transparent', borderRadius: 30, borderWidth: 1.5, borderColor: KIDS_COLOR.borderSoft, padding: SPACE.md, marginBottom: SPACE.md, minHeight: 120 },
