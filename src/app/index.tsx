...
const sh = StyleSheet.create({
  ...
  kidsPlayHeaderCard: {
    ...
    paddingHorizontal: SPACE.md,
    paddingVertical: 16,
    backgroundColor: KIDS_COLOR.softSunshine,
    borderWidth: 1.5,
    borderColor: 'rgba(255, 166, 43, 0.28)',
    marginBottom: SPACE.md,
  },
  kidsSectionSub: {
    color: KIDS_COLOR.textSecondary,
  ...
  kidsAdventureCardSpeak: {
    backgroundColor: KIDS_COLOR.softCoral,
    borderColor: 'rgba(246, 79, 114, 0.25)',
  },
  kidsAdventureCardTranslate: {
    backgroundColor: KIDS_COLOR.softSky,
    borderColor: 'rgba(49, 189, 237, 0.25)',
  },
  kidsAdventureCardStories: {
    backgroundColor: KIDS_COLOR.softPurple,
    borderColor: 'rgba(122, 69, 216, 0.22)',
  },
  kidsAdventureCardQuiz: {
    backgroundColor: KIDS_COLOR.softSunshine,
    borderColor: 'rgba(255, 166, 43, 0.26)',
  },
  kidsAdventureIcon: {
    width: 64,
    height: 64,
