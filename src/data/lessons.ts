...
const LEVEL_4A: Level = {
  ...
  sections: [
    ...
    },
    {
      ...
      { igbo: 'Nwanne', english: 'Brother', emoji: '👦🏾' },
      { igbo: 'Nwanne', english: 'Sister', emoji: '👧🏾' },
      { igbo: 'Nwa nwoke', english: 'Son', emoji: '👦🏾' },
      { igbo: 'Ada', english: 'Daughter', emoji: '👧🏾' },
      { igbo: 'Ụmụnne', english: 'Siblings', emoji: '🧒🏾' },
      { igbo: 'Nna nna', english: 'Grandfather', emoji: '👴🏾' },
      { igbo: 'Nne nne', english: 'Grandmother', emoji: '👵🏾' },
      { igbo: 'Nwanne nna', english: 'Uncle', emoji: '👨🏾' },
      { igbo: 'Nwanne nna', english: 'Aunty', emoji: '👩🏾' },
      { igbo: 'Nne na nna', english: 'Parent', emoji: '👨‍👩‍👧' },
      { igbo: 'Nwa', english: 'Child', emoji: '🧒🏾' },
      { igbo: 'Ọgbọ', english: 'Generation', emoji: '🌳' },
      { igbo: 'Ezinụlọ', english: 'Family', emoji: '👨‍👩‍👧‍👦' },
      { igbo: 'Ndị mmadụ', english: 'People', emoji: '👥' },
      { igbo: 'Enyi', english: 'Friend', emoji: '🤝' },
      { igbo: 'Ọbịa', english: 'Guest', emoji: '👋🏾' },
    ],
    },
  ],
};
