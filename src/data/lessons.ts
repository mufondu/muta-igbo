  ...
  sections: [
    {
      ...
      { igbo: 'Nku anya', english: 'Eyebrows', emoji: '👁️' },
      { igbo: 'Imi', english: 'Nose', emoji: '👃🏾' },
      { igbo: 'Ọnụ', english: 'Mouth', emoji: '👄' },
      { igbo: 'Ntị', english: 'Ear', emoji: '👂🏾' },
      { igbo: 'Aka', english: 'Hand', emoji: '✋🏾' },
      { igbo: 'Ụkwụ', english: 'Leg', emoji: '🦵🏾' },
    ...
    },
    {
      ...
      { igbo: 'Nwanne nna', english: 'Uncle', emoji: '👨🏾' },
      { igbo: 'Nwanne nne', english: 'Aunt', emoji: '👩🏾' },
  ...
  sections: [
    {
      ...
      items: [
      { igbo: 'Nkịta', english: 'Dog', emoji: 'Dog' },
      { igbo: 'Nwamba', english: 'Cat', emoji: 'Cat' },
      { igbo: 'Ọkụkọ', english: 'Chicken', emoji: 'Chicken' },
      { igbo: 'Ewu', english: 'Goat', emoji: 'Goat' },
      { igbo: 'Azụ', english: 'Fish', emoji: 'Fish' },
      { igbo: 'Nnụnụ', english: 'Bird', emoji: 'Bird' },
      { igbo: 'Agu', english: 'Leopard / Tiger', emoji: 'Leopard' },
      { igbo: 'Ọdụm', english: 'Lion', emoji: 'Lion' },
      { igbo: 'Enyi', english: 'Elephant', emoji: 'Elephant' },
      { igbo: 'Oke bekee', english: 'Rabbit', emoji: 'Rabbit' },
      { igbo: 'Oke', english: 'Rat', emoji: 'Rat' },
      { igbo: 'Eke', english: 'Python', emoji: 'Python' },
      { igbo: 'Mbe', english: 'Tortoise', emoji: 'Tortoise' },
      { igbo: 'Ụkpana', english: 'Grasshopper', emoji: 'Grasshopper' },
    ],
    },
    {
