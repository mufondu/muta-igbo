...
export const CUSTOM_ILLUSTRATIONS: Record<string, ImageSourcePropType> = {
  // family
  'family:grandmother': require('../../../assets/illustrations/custom/family/grandmother.png'),
  'family:grandfather': require('../../../assets/illustrations/custom/family/grandfather.png'),
  'family:mother': require('../../../assets/illustrations/custom/family/mother.png'),
