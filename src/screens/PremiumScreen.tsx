...
const s = StyleSheet.create({
  ...
  backBtn: { width: 42, height: 42, borderRadius: 999, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', borderWidth: 1, borderColor: KIDS_COLOR.borderSoft },
  ...
  featureCard: { ...KIDS_SHADOW.softCard, width: '48%', minHeight: 138, borderRadius: 26, padding: 13, backgroundColor: 'transparent', borderWidth: 1, borderColor: KIDS_COLOR.borderSoft },
  ...
  planMonthly: { backgroundColor: 'transparent', borderRadius: 28, padding: SPACE.md, alignItems: 'center', marginBottom: SPACE.lg, borderWidth: 1.5, borderColor: KIDS_COLOR.borderSoft },
