...
export const HISTORY_SECTIONS: HistorySection[] = [
  ...
  {
    id: 'enuani',
    title: 'The Enuani and Ogwashi-Ukwu People',
    igboTitle: 'Ndị Enuani na Ogwashi-Ukwu',
    emoji: '🌊',
    facts: [
      {
        id: 'enuani_location',
        ...
        title: 'Who Are the Enuani Igbo?',
        igboTitle: 'Ndị Enuani Bụ Ndị Igbo',
        emoji: '📍',
        body: 'The Enuani Igbo are a group of Igbo-speaking communities on the western bank of the Niger River, in present-day Delta State, Nigeria. Their name means "those above the river" (Enu = above, Ani = land/people). Key Enuani towns include Ogwashi-Ukwu, Asaba, Ibusa, Agbor, Issele-Uku, and Onicha-Ugbo. They are closely related to the Central Igbo (Anambra) but have developed their own distinct dialects and cultural traditions over centuries.',
        source: 'Igbo linguistic and cultural studies',
      },
      {
        id: 'ogwashi',
        era: 'History',
        year: 'Ancient to present',
        title: 'Ogwashi-Ukwu: Royal Town of the Enuani',
        igboTitle: 'Ogwashi-Ukwu: Ọ Bụ Obodo Eze',
        emoji: '👑',
        body: 'Ogwashi-Ukwu is one of the foremost royal towns among the Enuani Igbo, with a traditional monarchy and rich cultural heritage. The town is known for its distinct dialect, which preserves older forms of the Igbo language not found in Standard Central Igbo. Ogwashi-Ukwu also has a strong tradition of masquerade festivals, bronze work, and storytelling, connecting it to the broader Igbo-Ukwu archaeological tradition.',
        source: 'Enuani cultural heritage records',
      },
      {
        id: 'enuani_dialect',
        era: 'Language',
        year: 'Ancient to present',
        title: 'The Enuani Dialect',
        igboTitle: 'Asụsụ Enuani',
        emoji: '🗣️',
        body: 'The Enuani dialect, spoken in towns like Ogwashi-Ukwu, differs from Standard Central Igbo (Anambra Igbo) in vocabulary, pronunciation, and some grammatical structures. For example, Standard Igbo "Ihe" (thing) becomes "Nhẹ" or "Ighẹ" in Enuani. "Nna" (Father) becomes "Ịna." These differences reflect centuries of independent development while maintaining the core Igbo language structure. Preserving this dialect is the mission of Mụta Igbo.',
        source: 'Mụta Igbo linguistic research; Enuani community elders',
      },
    ],
  },
  {
    ...
    facts: [
      {
        ...
        emoji: '🌍',
        body: 'The Igbo language is spoken by over 45 million people, making it one of the largest languages in Africa and the world. It belongs to the Niger-Congo language family. Standard Central Igbo (Anambra dialect) serves as the literary and broadcast standard, while dozens of regional dialects including Enuani, Ikwerre, Ika, and Ekpeye preserve the rich linguistic diversity of Igboland.',
